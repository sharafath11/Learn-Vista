...
import { IMentorCourseLessonsPageProps } from "@/src/types/lessons";
...
export default function CourseLessonsPage({
  ...
  function onSubmit(data: LessonFormValues) {
    ...
    setOpen(false);
    form.reset();
    showSuccessToast("Your lesson has been added successfully.");
  }
                  ...
                  <div className="flex-1 p-4">
                    <div className="flex justify-between items-start">
                      ...
                      <div className="flex space-x-2">
                        ...
                        <Link
                          href={`/dashboard/courses/${course.id}/lessons/${lesson.id}/questions`}
                        >
                    ...
                    <FormField
                      ...
                      render={({ field }) => (
                        <FormItem>
                          ...
                          <FormDescription>
                            Leave blank to use a default thumbnail
                          </FormDescription>
                          <FormMessage />
                        </FormItem>
                      )}
