...
const dummyConcerns: Concern[] = [
  {
    id: "1",
    message: "Students are having difficulty understanding the advanced concepts in Module 3. The pace seems too fast and many are falling behind. Several students have reached out individually expressing confusion about the React hooks implementation.",
    attachments: [
      { filename: "student_feedback_survey.png", url: "#", type: "image" },
      { filename: "confusion_recording_session2.mp3", url: "#", type: "audio" },
      { filename: "module3_feedback.pdf", url: "#", type: "document" },
    ],
    status: "pending",
  ...
  {
    id: "2",
    message: "Technical issues with the video streaming platform during live sessions. Multiple students reported connection problems and audio lag during yesterday's session.",
    attachments: [
      { filename: "error_screenshot_main.jpg", url: "#", type: "image" },
      { filename: "network_diagnostics.pdf", url: "#", type: "document" }
    ],
    status: "resolved",
    createdAt: "2024-01-12T14:20:00Z",
    priority: "medium",
    resolution: "Platform upgraded to latest version and CDN optimized. Issues resolved and monitoring implemented.",
  },
  {
    id: "3",
    message: "Request for additional practice materials for the JavaScript fundamentals section. Current exercises are insufficient for beginners.",
    attachments: [],
    status: "in_progress",
  ...
  {
    id: "4",
    message: "Inappropriate behavior from a student during group discussions. Need guidance on how to handle this situation professionally while maintaining a positive learning environment.",
    attachments: [
      { filename: "incident_report_detailed.pdf", url: "#", type: "document" },
      { filename: "chat_logs_evidence.txt", url: "#", type: "document" },
    ],
    status: "escalated",
  ...
  {
    id: "5",
    message: "Assignment submission portal is not working correctly. Students are unable to upload their projects and the deadline is approaching.",
    attachments: [
      { filename: "portal_error.png", url: "#", type: "image" },
    ],
    status: "pending",
  ...
  {
    id: "6",
    message: "Great progress in the course! Students are showing excellent engagement and understanding. Just wanted to share some positive feedback.",
    attachments: [
      { filename: "positive_feedback.png", url: "#", type: "image" },
      { filename: "student_testimonials.mp3", url: "#", type: "audio" },
    ],
    status: "resolved",
    createdAt: "2024-01-05T15:30:00Z",
    priority: "low",
    resolution: "Acknowledged and shared with the team. Keep up the excellent work!",
  },
]
