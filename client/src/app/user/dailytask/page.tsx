...
import {
  Alert,
  AlertDescription,
} from "@/src/components/shared/components/ui/alert";
import {
  Card,
  CardContent,
  CardHeader,
      ...
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 p-4 md:p-6">
        <div className="max-w-4xl mx-auto">
          <Alert className="max-w-md mx-auto mt-20">
            ...
            <AlertDescription>
              No tasks found for today. Check back tomorrow for new challenges!
            </AlertDescription>
          </Alert>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
            Complete your daily tasks to improve your skills and track your
            progress
          </p>
        ...
        <Card className="max-w-2xl mx-auto border-0 shadow-lg bg-white/80 backdrop-blur-sm">
          ...
          <CardContent className="space-y-4">
            <div className="flex items-center justify-between">
              ...
              <Badge
                variant={
                  completedTasks === totalTasks ? "default" : "secondary"
                }
                className="text-sm"
              >
