...
const CertificateViewer = forwardRef<HTMLDivElement, CertificateViewerProps>(
  ({ certificate }, ref) => {
    const certificateBorderColor = certificate.isRevoked
      ? "border-red-300"
      : "border-blue-200"
    ...
    return (
      <div className="w-full overflow-x-auto">
        <div
          ref={ref}
          className={`min-w-[900px] lg:w-[1120px] h-auto mx-auto p-6 sm:p-10 bg-white relative rounded-xl ${
            certificate.isRevoked ? "bg-red-50" : "bg-blue-50"
          }`}
        >
          ...
          <div
            className={`relative border-8 border-double p-6 sm:p-8 bg-white rounded-xl shadow-xl ${certificateBorderColor} ${
          ...
          >
            ...
            <div className="text-center mb-8 sm:mb-10">
              ...
              />
              <h1 className="text-2xl sm:text-4xl font-bold text-gray-800 font-serif">
                {certificate.isRevoked
                  ? "Certificate of Revocation"
                  : "Certificate of Completion"}
              </h1>
              <div className="w-20 sm:w-24 h-1.5 bg-gradient-to-r from-indigo-500 to-blue-500 mx-auto rounded-full my-3" />
            ...
            <div className="text-center mb-8 sm:mb-10">
              ...
              <h2 className="text-3xl sm:text-5xl font-bold text-indigo-800 font-serif italic break-words mb-4">
                {certificate.userName}
              </h2>
              <p className="text-sm sm:text-lg text-gray-700">
                has{" "}
                {certificate.isRevoked
                  ? "had their completion of"
                  : "successfully completed"}{" "}
                the course
              </p>
              <h3 className="text-lg sm:text-2xl font-semibold text-gray-800 mt-3 break-words">
