    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-gray-50 to-gray-100 px-4 sm:px-6 lg:px-8">
      ...
      >
        <div className="bg-white rounded-2xl shadow-xl overflow-hidden p-8 space-y-8">
          ...
          {/* Success State */}
          {isSuccess ? (
            <div className="rounded-xl bg-gradient-to-r from-green-50 to-emerald-50 p-6 mt-8 transform transition-all duration-500 ease-out">
              <div className="flex flex-col items-center text-center">
                ...
                <div className="mt-6">
                  <WithTooltip content="Go back to the login page">
                    <Link
                      href="/user/login"
            ...
            <form ref={formRef} className="mt-8 space-y-6" onSubmit={handleSubmit}>
              <div className="space-y-2">
                ...
                <WithTooltip content="Enter your registered email to receive the reset link">
              ...
              <WithTooltip content="Click to send the password reset link to your email">
                <button
                  type="submit"
                ...
                >
                  {isSubmitting ? (
                    ...
                    <span className="absolute left-0 inset-y-0 flex items-center pl-3">
                      <Mail className="h-5 w-5 text-violet-300 group-hover:text-violet-200" />
                    </span>
                  )}
              ...
              <div className="flex items-center justify-center">
                <WithTooltip content="Return to login page without resetting password">
                  <Link
                    href="/user/login"
