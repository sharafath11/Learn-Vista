  ...
  const loadQuestion = async (index: number) => {
    ...
    try {
      ...
      if (res.ok && typeof res.data === "string") {
        const rawJson = res.data.trim().replace(/^```json\n/, "").replace(/\n```$/, "")
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
        <Card className="p-8 text-center bg-white/90 backdrop-blur-sm border-0 shadow-xl max-w-md">
          ...
          <WithTooltip content="Retry loading the PSC question">
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center p-4">
        <Card className="p-8 text-center bg-white/90 backdrop-blur-sm border-0 shadow-xl max-w-md">
          ...
          <WithTooltip content="Retry loading the question">
            <Button onClick={handleRetry} className="bg-blue-600 hover:bg-blue-700 w-full">Try Again</Button>
          </WithTooltip>
        </Card>
      </div>
    )
      ...
      <div className="max-w-4xl mx-auto">
        <div className="text-center mb-8">
          <div className="flex items-center justify-center gap-2 mb-4">
            ...
            <WithTooltip content="Welcome to PSC Fun Practice!">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
          <WithTooltip content="Your current score">
          ...
          <WithTooltip content="Number of questions attempted">
            <Card className="p-4 text-center bg-white/80 backdrop-blur-sm border-0 shadow-lg">
              <div className="flex items-center justify-center gap-2 mb-2">
          ...
          <WithTooltip content="Your accuracy percentage">
            <Card className="p-4 text-center bg-white/80 backdrop-blur-sm border-0 shadow-lg">
              <div className="flex items-center justify-center gap-2 mb-2">
          ...
          >
            <Card className="p-6 sm:p-8 bg-white/90 backdrop-blur-sm border-0 shadow-xl relative">
              ...
              <div className="mb-8">
                ...
                <WithTooltip content="Read the question carefully">
              ...
              <div className="space-y-3 mb-8">
                {currentQuestion.options.map((option, index) => (
                  <WithTooltip key={index} content={`Select option ${String.fromCharCode(65 + index)}`}>
                    <motion.button
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                {showResult && (
                  <>
                    <WithTooltip content="Move to the next question">
                      <Button
                    ...
                    <WithTooltip content="Try another random question">
                      <Button
