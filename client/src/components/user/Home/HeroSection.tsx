        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            <div className="inline-flex items-center px-4 py-2 bg-gradient-to-r from-[#8525FF]/10 to-[#8525FF]/5 rounded-full border border-[#8525FF]/20">
              <WithTooltip content="Rated #1 by learners in 2024">
                <Star className="h-4 w-4 text-[#8525FF] mr-2" />
              </WithTooltip>
              <span className="text-sm font-medium text-[#8525FF]">
            ...
            <p className="text-xl text-gray-600 leading-relaxed max-w-lg">
              Join millions of learners worldwide and accelerate your career
              with our premium courses taught by industry experts.
            </p>
            ...
            <div className="flex items-center space-x-8 pt-4">
              ...
              <WithTooltip content="Number of learners who joined this week">
          ...
          <div className="relative">
              ...
              <div className="space-y-6">
                <div className="bg-gradient-to-r from-[#8525FF]/10 to-[#A855F7]/10 rounded-2xl p-6 border border-[#8525FF]/20">
                  <div className="flex items-center justify-between mb-4">
                    <WithTooltip content="Course in progress">
                  ...
                  <p className="text-sm text-gray-600 mb-4">
                    Master React with hooks, context, and performance
                    optimization
                  </p>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <WithTooltip content="Average rating from learners">
            ...
            {/* Floating badges */}
            <WithTooltip content="Trusted by learners worldwide">
            ...
            <WithTooltip content="Recognized certifications">
