    ...
    <div className="bg-white rounded-xl shadow-sm p-6 transition-all hover:shadow-md border border-gray-100">
        ...
        <div className="relative inline-flex items-center justify-center">
          <svg className="w-24 h-24 transform -rotate-90" viewBox="0 0 100 100">
            ...
            <circle
              ...
              strokeDashoffset={`${2 * Math.PI * 40 * (1 - overallStats.overallProgress / 100)}`}
      ...
      <div className="mb-6">
        ...
        <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
          <div
            className={`h-full rounded-full bg-gradient-to-r ${getProgressColor(overallStats.overallProgress)} transition-all duration-1000 ease-out`}
      ...
      <div className="grid grid-cols-3 gap-4">
        <div className="text-center p-3 bg-gray-50 rounded-lg">
          ...
          <div className="text-lg font-bold text-gray-900">{overallStats.completedCourses}</div>
        ...
        <div className="text-center p-3 bg-gray-50 rounded-lg">
          ...
          <div className="text-lg font-bold text-gray-900">{overallStats.inProgressCourses}</div>
        ...
        <div className="text-center p-3 bg-gray-50 rounded-lg">
          ...
          <div className="text-lg font-bold text-gray-900">{overallStats.totalCourses}</div>
