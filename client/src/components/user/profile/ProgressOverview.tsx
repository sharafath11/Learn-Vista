...
export default function ProgressOverview() {
  ...
  if (progressData.overall.totalLessons === 0) {
    return (
      <WithTooltip content="Enroll in your first course to start tracking progress here.">
  ...
  return (
    <div className="bg-white rounded-xl shadow-sm p-6 transition-all hover:shadow-md border border-gray-100">
      <div className="flex items-center justify-between mb-6">
        ...
        <WithTooltip content="Your progress level is based on how much of your enrolled courses you’ve completed.">
      ...
      {/* Overall Progress */}
      <WithTooltip content="This shows the percentage of lessons you’ve completed across all enrolled courses.">
            ...
            <div className="relative inline-flex items-center justify-center">
              <svg className="w-32 h-32 transform -rotate-90" viewBox="0 0 100 100">
                ...
                <circle
                  ...
                  strokeDashoffset={`${
                    2 * Math.PI * 40 * (1 - progressData.overall.percentage / 100)
                  }`}
      ...
      {progressData.categories.length > 0 && (
        <WithTooltip content="Here’s how you’re progressing in each course category.">
          <div>
      ...
      {progressData.overall.percentage > 0 && (
        <WithTooltip content="A summary of your learning achievements so far.">
            ...
            <div className="flex items-center">
              ...
              <div>
                <p className="text-sm font-semibold text-green-800">
                  ...
                  {progressData.categories.length} categor
                  {progressData.categories.length !== 1 ? "ies" : "y"}!
                </p>
