...
class AdminCourseController implements IAdminCourseController {
  constructor(
    ...
    private adminCourseServices: IAdminCourseServices
  ) {}
  ...
  async addCategories(req: Request, res: Response): Promise<void> {
    try {
      ...
      const data = await this.adminCourseServices.addCategories(
        title,
        discription
      );
      sendResponse(
  ...
  async createClass(req: Request, res: Response): Promise<void> {
    try {
      ...
      if (!thumbnail)
        throwError("Thumbnail image is required", StatusCode.BAD_REQUEST);

      const result = await this.adminCourseServices.createClass(
        data,
        thumbnail.buffer
      );
      sendResponse(
  ...
  async getCourse(req: Request, res: Response): Promise<void> {
    try {
      ...
      if (!courses)
        throwError("Something went wrong", StatusCode.INTERNAL_SERVER_ERROR);
      sendResponse(
        res,
        StatusCode.OK,
  ...
  async updateConcernStatus(req: Request, res: Response): Promise<void> {
    try {
      ...
      await this.adminCourseServices.updateConcernStatus(
        concernId,
        status,
        resolution
      );
  ...
  async getAllConcerns(req: Request, res: Response): Promise<void> {
    try {
      ...
      const [data, total] = await Promise.all([
        ...
        this.adminCourseServices.countAllConcerns({ ...filterQuery, search }),
      ]);
